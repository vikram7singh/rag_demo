...
def rag_query(input):
    ...
    You are given the following context and you need to answer the question based on the context. 
...
# run_experiment("Experiment custom RAG pipeline")
run_experiment("Test custom RAG pipeline")